...
def build_tokenizer(args):
    ...
    elif args.tokenizer_type == "SeaLionTokenizer":
        assert args.tokenizer_model is not None
        tokenizer = _SeaLionTokenizer(
            args.tokenizer_model, vocab_extra_ids=args.vocab_extra_ids
        )
...
class _SeaLionTokenizer(AbstractTokenizer):
    """SeaLionTokenizer-Megatron wrapper"""

    def __init__(self, model_file, vocab_extra_ids=0):
        name = "SeaLionTokenizer"
        super().__init__(name)
    ...
    def _initalize(self, vocab_extra_ids):
        ...
        # _add_special_token("<MASK>")
        # self._mask_id = self._vocab["<MASK>"]
        _add_special_token("<|endoftext|>")
        self._eod_id = self._vocab["<|endoftext|>"]
